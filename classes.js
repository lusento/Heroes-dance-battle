...
class Hero {
  ...
  // Дочерний класс героя-лучника
  class Archer extends Hero {
    // Конструктор дочернего класса
    constructor(name, level, healthPoints, stats, isShootApple, energy) {
      super(name, level, healthPoints, stats);
      this.isShootApple = this.isShootApple; // Может попасть прямо в яблочко!
    ...
    displayHero() {
      ...
      if (this.isShootApple === "true") {
        console.log("Может попасть прямо в яблочко!");
      }
    }
  }
